...
provider "github" {
  # Configuration options
  token = "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"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="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"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/hasant23/bookstore-repo/main/"
          ...
          docker build -t hasant23/bookstoreapi:latest .
          docker-compose up -d 
          EOF
...
#https://raw.githubusercontent.com/hasant23/Hasan-Devops/main